    ...
    while (pcursor->Valid()) {
        ...
        try {
            ...
            if (chType == 'b') {
                ...
                pindexNew->nType        = diskindex.nType;
                pindexNew->nSHA256Base = diskindex.nSHA256Base;
                pindexNew->nScryptBase = diskindex.nScryptBase;
                pindexNew->nReserve0 = diskindex.nReserve0;
                pindexNew->nReserve1 = diskindex.nReserve1;
